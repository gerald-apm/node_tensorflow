...
const privateKey = fs.readFileSync('/etc/letsencrypt/live/api.easeplantz.ml/privkey.pem', 'utf8');
const certificate = fs.readFileSync('/etc/letsencrypt/live/api.easeplantz.ml/fullchain.pem', 'utf8');
